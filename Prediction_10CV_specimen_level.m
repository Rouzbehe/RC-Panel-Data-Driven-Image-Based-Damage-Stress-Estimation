...
[Imagess,specimenstxt] = xlsread('Input','All_f_M');  % All_f_RC   All_f   All_f_M All_f_M_fiber
...
%%%%%%%%%the approproate function should be chosen here for All, Recerse cylic and monotonic%%%%%%%%%%%%
 ...
 [OUTPUT_Training]=FeatureExtraction('segmented_f_M'); %segmented_f_all_190 segmented_f_M  segmented_f_M_con  segmented_f_M_fiber segmented_f_RC
...
X=[crack_features(:,:),Imagess(1:end,3:19)];%3:19 for monotonic-all and fiber     3:17 for monotonic-concrete   3:8 for all  
...
plotfname='square-ft_All_Monotonic-Speclevel_sigma 2_Gaussian_Feat-2,6,10,13,20,21,23';
...
feat=[2,6,10,13,20,21,23];            %16: ave cracks angle % 23: ave crack width 38;ft  39:fiber volume (vf)
...
testfeatNo=[36];  % 24: shear Stress (Mpa)  25: Shear STrain (10^-3) 27: Filure ratio (Shear Stress) 28: failre strain ratio 
...
plotCorrelation_CI_ft(tvp,plotfname,testfeatNo)
